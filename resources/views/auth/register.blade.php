...
<head>
    ...
    <body class="bg-[url(assets/img/background.png)] bg-cover bg-center flex items-center justify-center min-h-screen pt-16">
            ...
            <div class="bg-violet-50 rounded-lg p-10">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-2 flex rounded-lg overflow-hidden border border-purple-200">
                            <label class="flex-1 cursor-pointer">
                                <input type="radio" name="role" value="client" class="peer sr-only" {{ old('role', 'client') === 'client' ? 'checked' : '' }}>
                                <div class="text-center py-3 px-2 text-sm font-medium text-gray-600 transition
                                            hover:bg-purple-50
