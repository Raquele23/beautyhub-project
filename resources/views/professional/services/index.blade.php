    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-8 py-10 space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-purple-100 shadow-sm overflow-hidden">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 py-4 border-b border-purple-50 last:border-0">
                ...
                {{-- Ações --}}
                <div class="flex items-center gap-2 flex-shrink-0 self-start sm:self-center w-full sm:w-auto pl-[72px] sm:pl-0">
                    <a href="{{ route('services.edit', $service) }}"
                       class="inline-flex items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl transition-all duration-200 hover:-translate-y-0.5 flex-1 sm:flex-none"
                    ...
                    <form method="POST" action="{{ route('services.destroy', $service) }}"
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="inline-flex items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl bg-red-50 text-red-400 hover:bg-red-100 transition-all duration-200 hover:-translate-y-0.5 w-full">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
