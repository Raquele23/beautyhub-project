                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-3 sm:hidden">
                        <a href="{{ route('services.edit', $service) }}"
                           class="inline-flex items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl transition-all duration-200 flex-1"
                        ...
                        <form method="POST" action="{{ route('services.destroy', $service) }}"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                    class="inline-flex items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl bg-red-50 text-red-400 hover:bg-red-100 transition-all duration-200 w-full">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
