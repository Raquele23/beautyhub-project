        ...
        <div class="bg-white rounded-2xl border border-purple-100 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-4 px-6 py-4 border-b border-purple-50 last:border-0">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Ações: visíveis só no mobile (abaixo das infos) --}}
                    <div class="flex items-center gap-2 mt-3 sm:hidden">
                        <a href="{{ route('services.edit', $service->id) }}"
                           class="inline-flex flex-1 items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl transition-all duration-200"
                        ...
                        <form method="POST" action="{{ route('services.destroy', $service->id) }}"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                    class="inline-flex w-full items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl bg-red-50 text-red-400 hover:bg-red-100 transition-all duration-200">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                </svg>
                                Excluir
                ...
                {{-- Ações: visíveis só no desktop (à direita) --}}
