    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-8 py-10 space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                <a href="{{ route('professional.portfolio.manage', ['from' => 'show']) }}" class="hidden sm:inline-flex justify-center items-center gap-2 px-4 py-2 text-xs font-semibold text-purple-700 rounded-xl sm:w-auto transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md" style="background-color: #E3D0F9;">
                    ...
                    Portfólio
                     ...
                     <a href="{{ route('services.index') }}"
                         class="hidden sm:inline-flex justify-center items-center gap-2 px-4 py-2 text-xs font-semibold text-purple-700 rounded-xl sm:w-auto transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
                    ...
                    Serviços
                     ...
                     <a href="{{ route('professional.edit') }}"
                         class="inline-flex justify-center items-center gap-2 px-4 py-2 text-white text-xs font-semibold rounded-xl w-full sm:w-auto transition-all duration-200 hover:-translate-y-0.5 shadow-lg shadow-purple-200"
            ...
            <div class="relative h-36 w-full" style="{{ $bannerStyle }}">
                <div class="absolute left-1/2 -bottom-16 -translate-x-1/2 w-32 h-32 rounded-full border-4 border-white shadow-lg overflow-hidden" style="background-color: #EDE4F8;">
                    @if($professional->profile_photo)
                        <img src="{{ \Illuminate\Support\Facades\Storage::url($professional->profile_photo) }}" alt="Foto de perfil" class="w-full h-full object-cover">
                    @else
                               ...
                               <div @click.stop
                                ...
                                <form action="{{ route('professional.portfolio.update', $photo) }}"
                                    ...
                                    <div class="relative w-full max-w-[260px] mx-auto rounded-xl overflow-hidden bg-gray-100 aspect-[4/5]">
                                        <img src="{{ \Illuminate\Support\Facades\Storage::url($photo->original_photo ?? $photo->photo) }}"
                                        ...
                                        <label class="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity duration-200 flex items-center justify-center cursor-pointer group">
                                            ...
                                            <input type="file"
                                                   ...
                                                   data-original-src="{{ \Illuminate\Support\Facades\Storage::url($photo->original_photo ?? $photo->photo) }}">
                                        </label>
                                    </div>
        ...
        <div class="bg-white rounded-2xl border border-purple-100 shadow-sm overflow-hidden">
            ...
            <div class="flex flex-col gap-4 px-6 py-4 border-b border-purple-50 last:border-0 sm:flex-row sm:items-center sm:justify-between">

                <div class="flex items-start gap-4 min-w-0 flex-1">
                    <div class="w-14 h-14 rounded-xl overflow-hidden flex-shrink-0" style="background-color: #EDE4F8;">
                        @if($service->image)
                            <img src="{{ \Illuminate\Support\Facades\Storage::url($service->image) }}" alt="{{ $service->name }}" class="w-full h-full object-cover">
                        @else
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-2 mt-3 w-full sm:w-auto">
                            ...
                            <form method="POST" action="{{ route('services.destroy', $service->id) }}"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                        class="inline-flex w-full items-center justify-center gap-1 px-3 py-2 text-xs font-semibold rounded-xl bg-red-50 text-red-400 hover:bg-red-100 transition-all duration-200 hover:-translate-y-0.5">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                    </svg>
                                    Excluir
